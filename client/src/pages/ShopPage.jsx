          ...
          <div className="card rpg-panel rpg-panel-sandstone" style={{ borderRadius: 0, padding: 'var(--space-5)' }}>
            <div className="card pixel-border" style={{ padding: 'var(--space-4)', display: 'flex', flexDirection: 'column', gap: 'var(--space-4)', margin: 0, background: '#fcf8ee' }}>
              ...
              <div className="pixel-border gold-balance-box" style={{ marginTop: 'var(--space-2)', background: '#1c130c', border: '2px solid #d8a96d', padding: '10px 14px', borderRadius: 0, textAlign: 'center', boxShadow: 'inset 1px 1px 4px rgba(0,0,0,0.8), 2px 2px 0 rgba(0,0,0,0.4)' }}>
                ...
                <span className="font-pixel gold-label" style={{ color: '#ffffff', textShadow: '1px 1px 0 #000', fontSize: '8px', fontWeight: 600, display: 'block', marginTop: '4px' }}>YOUR GOLD BALANCE</span>
              </div>
