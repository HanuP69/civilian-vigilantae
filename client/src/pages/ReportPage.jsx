    ...
    <PageShell>
      ...
      <div className="rpg-panel-sandstone animate-fade-up stagger-2" style={{ padding:'6px', marginBottom:'var(--space-6)', borderRadius: 0 }}>
        <div className="card pixel-border" style={{ background:'#fcf8ee', border:'2px solid #85613c', padding:'16px 20px', color:'#291d12'}}>
          ...
          <p style={{ marginTop:'var(--space-3)', color:'#4a3522', fontWeight: 500, fontSize:'0.9rem', lineHeight: 1.5 }}>Report local troubles to the Town Council. The Vigilantae AI understands the problem, checks for similar reports, and alerts the nearest active wards immediately.
          </p>
        </div>
      </div>
            ...
            {step === 1 && (
              <div className="flex flex-col gap-6 animate-fade-up">
                <div className="flex items-center justify-between" style={{ borderBottom:'2px solid #85613c', paddingBottom:'6px', marginBottom:'12px'}}>
                  ...
                  <span className="font-pixel" style={{ fontSize:'7.5px', color:'#6b5139'}}>OPTIONAL · POWERS VIGILANTAE AI</span>
                </div>
